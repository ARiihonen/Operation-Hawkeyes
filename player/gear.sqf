...
switch _class do {
	...
	case "B_RECON_TL_F": { comment "Exported from Arsenal by Caranfin";
		...
		for "_i" from 1 to 4 do {player addItemToVest "RH_19Rnd_9x19_g18";};
	...
	case "B_RECON_F": {
		...
		player addItemToUniform "ACE_tourniquet";
		for "_i" from 1 to 4 do {player addItemToUniform "ACE_packingBandage";};
		for "_i" from 1 to 4 do {player addItemToUniform "RH_19Rnd_9x19_g18";};
		for "_i" from 1 to 4 do {player addItemToUniform "ACE_CableTie";};
		player addVest "TRYK_V_tacv10LC_OD";
		player addItemToVest "ACE_MapTools";
		for "_i" from 1 to 2 do {player addItemToVest "ACE_CableTie";};
	...
	case "B_HELIPILOT_F": {
		...
		player addItemToVest "RH_19Rnd_9x19_g18";
